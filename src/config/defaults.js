...
export function loadConfig(env = process.env) {
  ...
  return {
    ...
    optimizer: {
      ...
      walkForwardEnabled: toBoolean(env.OPTIMIZER_WALK_FORWARD_ENABLED, false),
      ...
      walkForwardMinPassRate: toNumber(env.OPTIMIZER_WALK_FORWARD_MIN_PASS_RATE, 0.5),
    ...
    risk: {
      ...
      maxConsecutiveRiskRejects: toPositiveInt(env.RISK_MAX_CONSECUTIVE_RISK_REJECTS, 0),
